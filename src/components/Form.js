...
class Form extends React.Component {
    ...
    onSubmit = async (event) => {
        ...
        //Be sure to change swiftrlink.com to your domain
        var generatedKey = nanoid(5);
        var generatedURL = "swiftrlink.com/" + generatedKey

        if (this.state.preferedAlias !== '') {
            generatedKey = this.state.preferedAlias
            generatedURL = "swiftrlink.com/" + this.state.preferedAlias
        }
        ...
        return (
            <div className="container">
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        <label htmlFor="basic-url">Your Swift URL</label>
                        <div className="input-group mb-3">
                            <div className="input-group-prepend">
                                <span className="input-group-text">swiftrlink.com/</span>
                            </div>
                            <input
                                id="preferedAlias"
                                onChange={this.handleChange}
